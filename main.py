    ...
    while cap.isOpened():
        ...
        try:
            ...
            """if angle_left < 60 and angle_right < 60:
                stage_sp = "initial"
            if angle_left > 150 and angle_right > 150 and stage_sp == "down" and angle_left_sp > 110:
                stage_sp = "top"
        ...
        # Rep data
        cv2.putText(image, 'Reps_Bicepcurls', (15, 12),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 0), 1, cv2.LINE_AA)
        cv2.putText(image, str(counter_bicepcurl),
                    (10, 60),
